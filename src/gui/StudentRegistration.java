...
public class StudentRegistration extends javax.swing.JFrame {
    ...
    public StudentRegistration(StudentEnrollment se) {
        initComponents();
        Font f = new Font("Rubik", Font.PLAIN, 18);
        jTable1.getTableHeader().setFont(f);
        jLabel12.setText(Signin.userName);
    ...
    public void loadStudents() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT *  FROM `student` INNER JOIN `address` ON `address`.`id`=`student`.`address_id` INNER JOIN `city` ON `city`.`id` = `address`.`city_id` WHERE `status_id`='1' ORDER BY `student`.`sno` ASC");
    ...
    public void searchStudents() {
        ...
        if (sTerm.isEmpty()) {
            ...
            whereQuery = "AND `student`.`name`LIKE'" + sTerm + "%'";
        }
        try {
            ResultSet rs = MySQL.search("SELECT *  FROM `student` INNER JOIN `address` ON `address`.`id`=`student`.`address_id` INNER JOIN `city` ON `city`.`id` = `address`.`city_id` WHERE `status_id`='1' " + whereQuery + " ORDER BY `student`.`sno` ASC");
    ...
    private void initComponents() {
        ...
        jDateChooser1.setFont(new java.awt.Font("Rubik", 0, 12)); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Id", "Name", "DOB", "Address No", "1st Street", "2nd Street", "City"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (sid.isEmpty()) {
        ...
        } else if (!Pattern.compile("STU[-]\\d{4}").matcher(sid).matches()) {
            ...
            try {
                ...
                MySQL.iud("INSERT INTO `student`(`sno`,`name`,`dob`,`address_id`,`user_id`) VALUES ('" + sid + "','" + name + "','" + dob + "'," + Integer.parseInt(address_id) + "," + Signin.userId + ")");
                resetFields();
                loadStudents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 1) {
            ...
            try {
                Date dob = sdf.parse(jTable1.getValueAt(selectedRow, 2).toString());
        ...
        if(se!=null){
            se.jLabel4.setText(jTable1.getValueAt(selectedRow, 0).toString());
        se.jLabel5.setText(jTable1.getValueAt(selectedRow, 1).toString());
        se.jLabel8.setText(jTable1.getValueAt(selectedRow, 2).toString());
        se.jLabel9.setText(jTable1.getValueAt(selectedRow, 6).toString());
        se.jButton1.setText("Change Student");
                     this.dispose();
        }else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (sid.isEmpty()) {
            ...
            try {
                ...
                ResultSet rsx = MySQL.search("SELECT * FROM `student` WHERE `sno`='" + sid + "' AND`status_id`='1'");
                ...
                if (rsx.next()) {
                    ...
                    MySQL.iud("UPDATE `student` SET `name`='" + name + "',`dob`='" + dob + "' WHERE `sno`='" + sid + "'");
                    resetFields();
                    loadStudents();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int option = JOptionPane.showConfirmDialog(this, "Do you want to remove the selected student?", "Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);

                if (option == JOptionPane.YES_OPTION) {
                    MySQL.iud("UPDATE `student` SET `status_id`='2' WHERE `sno`='"+student_id+"'");
                    loadStudents();
                    resetFields();

                    JOptionPane.showMessageDialog(this, "student removed successfully", "Warning", JOptionPane.INFORMATION_MESSAGE);
